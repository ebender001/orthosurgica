...
struct SignInWithAppleView: View {
    ...
    let onSuccess: (_ identityToken: String, _ authorizationCode: String) -> Void
    let onCancel: () -> Void
    ...
    var body: some View {
        NavigationStack {
            VStack(alignment: .leading, spacing: 14) {
                ...
                if let explainerText, !explainerText.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty {
                    Text(explainerText)
                        .font(.subheadline)
